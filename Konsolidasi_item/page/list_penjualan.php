...
<html lang="en">
  ...
  <section id="container" >
      ...
      <!--main content start-->
       ...
       <section id="main-content">
          <section class="wrapper site-min-height">
            <h3><i class=""></i> List penjualan item planet</h3>
            <div class="row mt">
              <div class="col-lg-12">
              		<div>
                    Search By Date:<br> 
                  ...
                  <br>
              			 <div id="wrapper">
                        <table id="listpenjualan" class="display compact" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>No Faktur</th>
                <th>No.</th>
    ...
    <script type="text/javascript" src="../include/listpenjualanpage/clientside/listpenjualanController.js"></script>
