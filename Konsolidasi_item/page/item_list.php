...
<html lang="en">
  ...
  <section id="container" >
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                       <a href="list_item.php" class=""><i class="fa fa-angle-double-right"></i>View Item List</a>             
          ...
          <section class="wrapper site-min-height">
            ...
            <div class="row mt">
              <div class="col-lg-12">
              			 ...
              			 <div id="wrapper">
                        <table id="item_list" class="display compact" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>No.</th>
                <th>Description</th>
                ...
                <th>Sita</th>
                 <th>Inventory</th>
                <th class="">Brand</th>
                 <th class="numeric">Nilai Stock</th>
                <th class="numeric">Stock Condition</th>
                <th class="numeric">Base Unit of Measure</th>
                <th class="">Posting grup</th>
    ...
    <script type="text/javascript" src="../include/itemlistpage/clientside/item_listController.js"></script>
